...
The process used to create the dataset is as follows:

1. Merges the training and the test sets to create one data set.
2. Extracts only the measurements on the mean and standard deviation for each measurement. This was accomplished by looking for matches of "std" and "mean" in the column names of the dataset.
3. Uses descriptive activity names to name the activities in the data set. This was accomplished by using the integer-to-string conversion provided by the original dataset to rename the activities column.
